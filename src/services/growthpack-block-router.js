(function () {
  const BLOCKS = [
    {
      key: 'crm_funil',
      label: 'CRM & Funil',
      aliases: ['BASE_CRM', 'BASE DO CRM', 'DASH_CRM'],
      preferred: ['BASE_CRM', 'BASE DO CRM', 'DASH_CRM'],
      description: 'Base do CRM, funil, etapas e oportunidades.'
    },
    {
      key: 'fca',
      label: 'FCA',
      aliases: ['BASE_CRM', 'BASE DO CRM', 'DASH_CRM', 'Chart1 Distribuição Percentual', '[Chart1] Distribuição Percentual dos Motivos de Perda'],
      preferred: ['[Chart1] Distribuição Percentual dos Motivos de Perda', 'Chart1 Distribuição Percentual', 'DASH_CRM', 'BASE_CRM', 'BASE DO CRM'],
      description: 'FCA continua priorizando a planilha oficial e pode apoiar com CRM/motivos de perda.'
    },
    {
      key: 'leads_lp',
      label: 'Leads / LPs',
      aliases: ['bd Leads LP'],
      preferred: ['bd Leads LP'],
      description: 'Leads vindos de landing pages.'
    },
    {
      key: 'meta_ads',
      label: 'Meta Ads',
      aliases: ['bd Meta Ads'],
      preferred: ['bd Meta Ads'],
      description: 'Base bruta de Meta Ads.'
    },
    {
      key: 'google_ads',
      label: 'Google Ads',
      aliases: ['bd Google Ads'],
      preferred: ['bd Google Ads'],
      description: 'Base bruta de Google Ads.'
    },
    {
      key: 'analytics',
      label: 'Analytics',
      aliases: ['bd Analytics'],
      preferred: ['bd Analytics'],
      description: 'Dados de analytics e comportamento.'
    },
    {
      key: 'performance_mensal',
      label: 'Performance Mensal',
      aliases: ['1.0 Mensal', '1,0 Mensal'],
      preferred: ['1.0 Mensal', '1,0 Mensal'],
      description: 'Visão mensal da GrowthPack.'
    },
    {
      key: 'performance_semanal',
      label: 'Performance Semanal',
      aliases: ['2.0 Semanal'],
      preferred: ['2.0 Semanal'],
      description: 'Visão semanal da GrowthPack.'
    },
    {
      key: 'performance_diaria',
      label: 'Performance Diária',
      aliases: ['3.0 Diario', '3.0 Diário'],
      preferred: ['3.0 Diario', '3.0 Diário'],
      description: 'Visão diária da GrowthPack.'
    },
    {
      key: 'projecoes',
      label: 'Projeções',
      aliases: ['3.0 Projeção Cenários', '3.0 Projecao Cenarios'],
      preferred: ['3.0 Projeção Cenários', '3.0 Projecao Cenarios'],
      description: 'Cenários e projeções.'
    },
    {
      key: 'dre_financeiro',
      label: 'Financeiro / DRE',
      aliases: ['DRE projetado', 'Config DRE', 'CAC | MC | Breakeven', '💵 DRE projetado', '⚙️ Config DRE'],
      preferred: ['💵 DRE projetado', 'DRE projetado', 'CAC | MC | Breakeven', '⚙️ Config DRE', 'Config DRE'],
      description: 'DRE, CAC, margem e breakeven.'
    },
    {
      key: 'produtos',
      label: 'Produtos',
      aliases: ['PRODUTOS'],
      preferred: ['PRODUTOS'],
      description: 'Produtos/serviços cadastrados.'
    },
    {
      key: 'config_tecnica',
      label: 'Config Técnica',
      aliases: ['API_CONFIG', 'API_STATUS', 'Acessos e Senhas'],
      preferred: ['API_STATUS', 'API_CONFIG', 'Acessos e Senhas'],
      description: 'Status técnico, configuração e acessos.'
    }
  ];
  ...
  function sourceMatchesSearch(source, search) {
    ...
    return normalize(search).split(' ').every((token) => haystack.includes(token));
  }
  ...
  async function loadSources(filters = {}) {
    ...
    return {
      ok: true,
      data: filterSources(payload.data || [], filters),
      raw_count: (payload.data || []).length,
      filtered_count: filterSources(payload.data || [], filters).length,
      filters
    };
  }

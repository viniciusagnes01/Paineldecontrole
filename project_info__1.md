...
│       ├── crm-filter-panel.js  — Painel de filtragem de CRM por período/origem
...
- **Lifecycle**: observa o DOM e re-aplica branding sempre que a sidebar ou o hero do cliente é recriado.
